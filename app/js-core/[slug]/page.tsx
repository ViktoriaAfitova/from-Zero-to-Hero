import { allDocJs } from '@/.contentlayer/generated';
...
export function getDocJsParams(slug: string) {
  const article = allDocJs.find((doc) => doc.slugAsParams === slug);
  if (!article) notFound();
...
export default function PostPage({ params }: PageProps) {
  const doc = getDocJsParams(params.slug);
