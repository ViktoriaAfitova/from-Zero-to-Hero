import { allDocTs } from '@/.contentlayer/generated';
...
export function getDocTsParams(slug: string) {
  const article = allDocTs.find((doc) => doc.slugAsParams === slug);
  if (!article) notFound();
...
export default function PostPage({ params }: PageProps) {
  const doc = getDocTsParams(params.slug);
